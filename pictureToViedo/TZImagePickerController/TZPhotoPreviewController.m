...
- (void)viewWillAppear:(BOOL)animated {
   ...
   // if (iOS7Later) [UIApplication sharedApplication].statusBarStyle = UIStatusBarStyleDefault;
...
- (void)configCustomNaviBar {
   ...
   _naviBar.backgroundColor = [UIColor whiteColor];
    ...
    [_backButton setImage:[UIImage imageNamedFromMyBundle:@"leftArrow"] forState:UIControlStateNormal];
...
//    [_selectButton setImage:tzImagePickerVc.photoSelImage forState:UIControlStateSelected];
        [_selectButton setImage:[UIImage imageNamed:@"Rectangle"] forState:UIControlStateNormal];
        [_selectButton setImage:[UIImage imageNamed:@"Rectangle"] forState:UIControlStateSelected];
...
- (void)viewDidLayoutSubviews {
  ...
  //  CGFloat statusBarHeightInterval = statusBarHeight-10;
  ...
  //  _indexLabel.frame = _selectButton.frame;
    ...
    _indexLabel.frame = CGRectMake(100, statusBarHeight, [UIScreen mainScreen].bounds.size.width-200,44);
...
- (void)refreshNaviBarAndBottomBarState {
    ...
    if (_selectButton.isSelected && _tzImagePickerVc.showSelectedIndex) {
        ...
        _indexLabel.text = [NSString stringWithFormat:@"%@/%ld",index,self.photos.count];
